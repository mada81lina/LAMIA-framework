...
public class TestReporter implements IReporter {
    ...
    protected void writeHead() {
        writer.print("<head>");
        writer.print("<title>LAMIA Report</title>");
        writeStylesheet();
        writer.print("</head>");
    }
    ...
    protected void writeReportTitle( String title ) {
        writer.print("<font color = #fc00c1><h1>" + title+ "</font></h1>");
        writer.print("<font color = gray><h3>"+ getDateAsString() + "</font></h3>");
    }
            ...
            for ( ClassResult classResult : classResults ) {
                ...
                for ( MethodResult methodResult : classResult.getMethodResults() ) {
                    ...
                    buffer.append("<td><a href=\"#m").append(scenarioIndex)
                            ...
                            .append( decimalFormat.format( millisecondsToMinutes( duration ) ) ).append("</td></tr>");
                    scenarioIndex++;
    ...
    protected double millisecondsToMinutes(long ms ) {
        return new BigDecimal( ms/60000.00 ).setScale( 2, RoundingMode.HALF_UP ).doubleValue();
    }
